...
const PAGES = [
    ...
    { name: "Composers", id: "composers", desc: "Browse Umbraco Composers grouped by assembly" },
    { name: "Notification Handlers", id: "notificationHandlers", desc: "Browse Umbraco notification handlers" },
    { name: "Hosted Services", id: "hostedServices", desc: "Browse hosted and background services" },
    { name: "Middleware", id: "middleware", desc: "Browse ASP.NET Core middleware types" },
