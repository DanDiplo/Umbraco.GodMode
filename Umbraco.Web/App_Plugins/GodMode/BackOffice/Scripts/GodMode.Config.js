...
angular.module("umbraco")
    ...
    .directive('godmodeTrueFalse', function () {
        return {
            ...
            template: '<span ng-show="value"><i class="icon icon-checkbox"></i> Yes</span><span ng-hide="value"><i class="icon icon-checkbox-empty"></i> No</span>'
        }
    })
    ...
    .directive('godmodeHeader', function ($route, godModeConfig) {
        return {
            ...
            templateUrl: "/App_Plugins/GodMode/BackOffice/GodModeTree/godModeHeader.html"
        }
    })
