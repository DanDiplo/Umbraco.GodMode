...
If you ever need to change the Umbraco.Core dependency (currently v7.4.3), you will need to update the version in both \BuildPackage\Package.build.xml & \BuildPackage\package.nuspec